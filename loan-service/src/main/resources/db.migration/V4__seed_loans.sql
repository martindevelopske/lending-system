...
VALUES
    ('i1a1b1c1-d1e1-1111-1111-111111111111', 'd2f3a4b5-c6d7-8901-bcde-f12345678901', 1, 8583.3400, 8583.3400, '2024-02-15', 'PAID'),
    ('i2a2b2c2-d2e2-2222-2222-222222222222', 'd2f3a4b5-c6d7-8901-bcde-f12345678901', 2, 8583.3400, 0.0000, '2024-03-15', 'PENDING'),
    ('i3a3b3c3-d3e3-3333-3333-333333333333', 'd2f3a4b5-c6d7-8901-bcde-f12345678901', 3, 8583.3400, 0.0000, '2024-04-15', 'PENDING'),
    ('i4a4b4c4-d4e4-4444-4444-444444444444', 'd2f3a4b5-c6d7-8901-bcde-f12345678901', 4, 8583.3400, 0.0000, '2024-05-15', 'PENDING'),
    ('i5a5b5c5-d5e5-5555-5555-555555555555', 'd2f3a4b5-c6d7-8901-bcde-f12345678901', 5, 8583.3400, 0.0000, '2024-06-15', 'PENDING'),
    ('i6a6b6c6-d6e6-6666-6666-666666666666', 'd2f3a4b5-c6d7-8901-bcde-f12345678901', 6, 8583.3000, 0.0000, '2024-07-15', 'PENDING');

INSERT INTO repayments (id, loan_id, amount, payment_reference, payment_method, paid_at)
VALUES ('r1a1b1c1-d1e1-1111-1111-111111111111', 'd2f3a4b5-c6d7-8901-bcde-f12345678901', 8583.3400, 'PAY-001-2024', 'MPESA', '2024-02-14 10:30:00');
...
INSERT INTO repayments (id, loan_id, amount, payment_reference, payment_method, paid_at)
VALUES ('r2b2c2d2-e2f2-2222-2222-222222222222', 'd3a4b5c6-d7e8-9012-cdef-123456789012', 200.0000, 'PAY-002-2024', 'MPESA', '2024-01-10 14:00:00');
